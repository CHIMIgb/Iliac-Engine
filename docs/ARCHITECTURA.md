...
├── io/                   # FileManager (export/import JSON, C5c sin localStorage), Serializer (↔ project.json v3), StartProject (C5d: documento de partida desde la API), CloudProject (C5b: guardar/cargar por API), assetApi (C5c: sprites/audio por API), api (cliente HTTP C5a–C5f, con auto-renovación de sesión), session (tokens)
