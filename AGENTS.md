...
- **F4.7 realizada:** **cielo realista con ciclo día/noche** (`world.sky.style:'realista'`): sol/luna visibles con shader atmosférico, estrellas, sombras PCF 2048, avance automático en playtest e interiores que atenúan el sol — todo junto al telón clásico Daggerfall (pestañas Clásico|Realista en el popover del Cielo, tecla 8). Ver `ROADMAP.md` §11.
