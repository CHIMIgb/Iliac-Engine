...
- **Cada vez que se complete una fase del ROADMAP, marcarla como terminada** en la tabla de "Estado del plan" (`ROADMAP.md` §12). No quedarse en código: el plan debe reflejar el avance.
