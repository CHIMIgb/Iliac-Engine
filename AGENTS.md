...
- **F4.7 realizada:** **cielo realista con ciclo día/noche** (`world.sky.style:'realista'`): sol/luna visibles con shader atmosférico, estrellas de 1 px con parpadeo, **aurora boreal de noche en el polo norte** (domo GLSL procedural translúcido aditivo, toggle + intensidad), sombras PCF 2048, avance automático en playtest e interiores que atenúan el sol — todo junto al telón clásico Daggerfall (pestañas Clásico|Realista en el popover del Cielo, tecla 8). La demo muestra además una brújula (rosa N/E/S/O) en la esquina inferior derecha. Ver `ROADMAP.md` §11.
