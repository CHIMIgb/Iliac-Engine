...
- **`auroraColor`** — color de la aurora en hex `'#rrggbb'` (default `'#7dffb0'`, el verde natural). Con la ganancia elevada, la cortina baja casi hasta el horizonte norte y se ve bien marcada.
