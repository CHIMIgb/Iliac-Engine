...
`world.sky: { style: 'realista', hour?: 0–24, dayLengthSec?: >0, shadows?: bool, sunTilt?: 0–90, sunIntensity?: 0.1–3, moonIntensity?: 0–1, stars?: bool, aurora?: bool, auroraIntensity?: 0.1–3 }`
...
- **`aurora`** — true = aurora boreal visible de noche (default true). Cortina de luz verde→cian→violeta en el **polo norte del mundo** (-Z del espacio Three).
...
**UI (tecla 8):** pestaña Realista = slider **Hora 0–24** (+ HH:MM), select **Avance del día** (Fijo / 10′ / 20′ / 60′), checkbox **Sombras del sol**, input **Inclinación solar (0–90°)**, slider **Intensidad del sol (×0.1–3)**, slider **Luz de la luna (0–100%)**, checkbox **Estrellas de noche**, checkbox **Aurora boreal**, slider **Intensidad aurora (×0.1–3)**. Todo escribe `doc.setSky`. Cambiar de pestaña conserva los datos del otro estilo.
