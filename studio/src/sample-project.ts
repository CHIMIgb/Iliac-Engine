 ...
 * Daggerfall SKY15. Sin guardar nada: `npm run dev` y Playtest directamente.
 */
...
function buildDefaultDoc(): EditorState {
  ...
  // Look retro del playtest: buffer Daggerfall 320×200 (tecla 9 cambia).
  doc.render = { ...doc.render, resolution: [320, 200] };
