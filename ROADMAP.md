...
| F4+ **Pantalla (tecla 9)**: `render.resolution` (buffer interno 320×200…nativa con píxel duro) + `render.crt` — CRT propio en Renderer3D (curvatura+scanlines+viñeta, three puro sin dependencias), activo solo en playtest; default del proyecto inicial: CRT + 320×200 | ✅ Realizada |
