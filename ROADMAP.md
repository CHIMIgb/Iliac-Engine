...
| F4+ **Pantalla (tecla 9)**: `render.resolution` (buffer interno fijo 320×200…nativa, estirado con píxel duro por CSS) — default del proyecto inicial 320×200. El efecto CRT quedó **retirado** por decisión del usuario | ✅ Realizada |
