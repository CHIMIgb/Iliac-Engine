...
| F4+ **Herramienta Terreno (tecla 7)**: suelo plano de 8–32 m sobre la cuadrícula (un único sector de 4 vértices, sin relieves/paredes), elevado a la base del sector bajo el clic; **modo Moldear** esculpe de forma continua (2 m/s frame-independent vía `update(dt)`) con dirección fija según Elevar/Hundir, solo sobre terrenos ya colocados, y altura en vivo en la statusbar | ✅ Realizada |
