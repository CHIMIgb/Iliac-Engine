...
| F5 Asset Pipeline (Asset Manager, Sprite Pipeline) | ⏳ Pendiente (Fase A del Sprite Tool ✅: slicer Auto + Manual — Sprite Tool modal con Paso 1 Cargar y Paso 2 Cortar; Auto = detectSprites con sliders minPixels/gapTolerance + trim, Manual = gridSlice cols×rows/spacing/trailingEmpty con celda derivada; preview numerado en vivo, recorte no destructivo a frames en memoria `textureKeyFor(assetId,i)`, thumbs; cifras 15 suites/179 tests Studio + 162 motor; animador Paso 3 y biblioteca de sprites sueltos pendientes) |
