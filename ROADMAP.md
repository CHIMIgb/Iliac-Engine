...
| F4+ **Cielo Daggerfall (tecla 8)**: horizonte lejano `world.sky {set:0–30}` — técnica clásica de telón 2D (dos billboards anclados al horizonte, scrolleo UV por los 32 fotogramas-ventana, paralaje 0.5×; sin skybox 3D); `npm run setup:sky` importa los assets (no versionados); demo con SKY15 | ✅ Realizada |
