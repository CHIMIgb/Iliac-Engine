...
| 6.8 | **Audio Tool** — MVP ambiente (tecla 9) | ✅ F4.6.a | Popover de bucles `bus:'ambience'` (archivo del manifest, volumen, preview, quitar); arrancan en bucle al entrar al playtest y callan al salir. Música/NPC/Acciones: modelo de datos vivo, editor pendiente |
