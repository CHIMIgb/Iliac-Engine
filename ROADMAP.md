...
| F4+ **Herramienta Terreno (tecla 7)**: suelo plano de 8–32 m como grilla de celdas de 2 m con vértices compartidos (formato `floorH` por vértice del motor); **modo Moldear** esculpe con PINCEL solo la zona bajo el cursor (radio 3 m, decaimiento suave, 2 m/s frame-independent vía `update(dt)`, dirección fija según Elevar/Hundir); Mover traslada la colocación completa como una pieza; altura en vivo en la statusbar | ✅ Realizada |
